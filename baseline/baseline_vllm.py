...
def get_model(num_examples):
    ...
    class ChatChain:
        def __init__(self, template, tokenizer, model) -> None:
    ...
    theme_chain = ChatChain(theme_prompt_template, tokenizer, llm)
    ...
    def get_generation_prompt():
        ...
        return ChatChain(generation_prompt_template, tokenizer, llm)
    ...
    def get_distractors_prompt():
        ...
        distractors_chain = ChatChain(distractors_prompt_template, tokenizer, llm)
